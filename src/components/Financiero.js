...
function Financiero(){
    return(
        <div id="EstadosF">
            ...
            <h4 className="tabla-name"><b>Activo circulante</b></h4>
            ...
            {/*Siguiente*/}
            <h4 className="tabla-name"><b>Activo fijo</b></h4>
            <div className="container tabla bg-dark text-white p-0">
                <div className="row d-flex justify-content-between m-0 p-1 px-4">
            ...
            {/*Siguiente*/}
            <h4 className="tabla-name"><b>Activo diferido</b></h4>
            <div className="container tabla bg-dark text-white p-0">
                <div className="row d-flex justify-content-between m-0 p-1 px-4">
            ...
            <div className="row bg-dark mx-0 mt-4 p-0 d-flex justify-content-center">
                <h3 className="text-light p-5">Suma del activo: $41 704 000</h3>
            </div>
            {/**Siguiente */}
            <h2 className="text-center pt-5 text-uppercase font-weight-bold">Pasivo</h2>
            <h4 className="tabla-name"><b>Pasivo Circulante</b></h4>
            <div className="container tabla bg-dark text-white p-0">
                <div className="row d-flex justify-content-between m-0 p-1 px-4">
            ...
            {/**Siguiente */}
            <h4 className="tabla-name"><b>Pasivo a largo plazo</b></h4>
            <div className="container tabla bg-dark text-white p-0">
                <div className="row d-flex justify-content-between m-0 p-1 px-4">
            ...
            <h4 className="tabla-name"><b>Capital Contable</b></h4>
            <div className="container tabla bg-dark text-white p-0">
                <div className="row d-flex justify-content-between m-0 p-1 px-4">
